          ...
          >
            ...
            <div className="scroll-region flex-1 overflow-y-auto overscroll-contain">
              <div className="md:grid md:grid-cols-[minmax(0,1fr)_minmax(0,1.15fr)]">
                {/* Cover */}
                <div className="relative border-b border-hairline bg-surface md:sticky md:top-0 md:h-full md:min-h-[26rem] md:border-b-0 md:border-r">
                  ...
                  <div className="pointer-events-none absolute inset-x-0 bottom-0 flex items-end justify-between gap-4 p-5">
                    <span className="mono-label bg-void/75 px-2 py-1.5 text-paper-dim backdrop-blur-sm">
                      {project.type}
                    </span>
                    <span className="mono-label bg-void/75 px-2 py-1.5 text-paper-dim backdrop-blur-sm">
                      {project.status}
                ...
                <div className="flex flex-col gap-6 p-6 md:p-10">
                  ...
                  <h2 className="max-w-[22ch] font-serif text-[clamp(1.6rem,4vw,2.35rem)] font-normal leading-[1.1] tracking-[-0.01em]">
                    {project.title}
                  </h2>
